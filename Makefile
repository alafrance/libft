...
MY_FILES	= ft_strrev_bonus.c ft_putnbr_base_bonus.c ft_atoi_base_bonus.c ft_convert_base_bonus.c \
...
SRC_BONUS	= $(addprefix ${SRC_PATH},${FILES_BONUS}) $(addprefix ${SRC_PATH},${MY_FILES})
CC			= gcc
OBJS 		= ${SRC:.c=.o}
